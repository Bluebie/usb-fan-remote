# Name: Makefile
# Project: usb-lamp
# Author: Christian Starkjohann, revised by Jenna Fox
# Creation Date: 2007-06-23, 2011-08-13
# Tabsize: 4
...
COMPILE = avr-gcc -Wall -Os -Iusbdrv -I.  -I../utils -mmcu=$(DEVICE) -DF_CPU=$(SPEED) -DDEBUG_LEVEL=0
# NEVER compile the final product with debugging! Any debug output will
# distort timing so that the specs can't be met.

OBJECTS = usbdrv/usbdrv.o usbdrv/usbdrvasm.o usbdrv/oddebug.o usb-fan-remote.o
